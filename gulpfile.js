...
var args       = minimist(process.argv.slice(2)),
    ...
    remotePath = '/public_html/sonnyportfolio/',
    analytics  = "<script>(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');ga('create', '" + args.analytics + "', 'auto');ga('send', 'pageview');</script>"
 ...
 * build task
 *
 * gulp build --analytics universal_analytics_code
 */
